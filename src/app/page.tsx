  ...
  const submitPayout = async () => {
    ...
    try {
      await payOutCommunityFunds(
        ...
        amount,
        payoutMemo.trim() || `commons:payout:${activeCommunity?.name ?? "community"}`
      );
      setPayoutState("sent");
      setPayoutRecipient("");
      setPayoutAmount("");
      ...
      setPayoutError(error instanceof Error ? error.message : "Could not pay out funds.");
      setPayoutState("idle");
    }
  };
